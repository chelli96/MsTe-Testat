...
namespace AutoReservation.Ui.ViewModels
{
    public class ReservationViewModel : ViewModelBase
    {
        ...
        private void Delete()
        {
            ...
            {
                MessageBox.Show("A handled exception just occurred: " + FaultException.Message, "Exception Sample", MessageBoxButton.OK, MessageBoxImage.Warning);
            }
        }
        ...
        #region Load-Active-Command

        private RelayCommand loadActiveCommand;

        public ICommand LoadActiveCommand
        {
            get
            {
                return loadActiveCommand ?? (loadActiveCommand = new RelayCommand(param => LoadActive(), param => CanLoadActive()));
            }
        }
